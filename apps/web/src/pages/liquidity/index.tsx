...
import { isStableSwapSupported, isV2Supported } from '@pancakeswap/smart-router/evm'
import {
  AddIcon,
  Button,
  ButtonMenu,
          ...
          filter={
            <>
              ...
              >
                ...
                <ButtonMenuItem display={isV2Supported(chainId) ? 'inline-flex' : 'none'}>V2</ButtonMenuItem>
