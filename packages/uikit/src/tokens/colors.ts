export const baseColors = {
  ...
  failure: "#ED4B9E",
  failure33: "#ED4B9E33",
  primary: "#70a3f3", // "#1FC7D4",
  primary0f: "#70a3f30f",
  primary3D: "#70a3f33D",
  primaryBright: "#9dc4f8", // "#53DEE9",
  primaryDark: "#3661e3", // "#0098A1",
  success: "#31D0AA",
  success19: "#31D0AA19",
  warning: "#FFB237",
  warning2D: "#ED4B9E2D",
...
export const lightColors = {
  ...baseColors,
  ...additionalColors,
  secondary: "#3662e3", // "#7645D9",
  secondary80: "#3662e380", // "#7645D980",
  background: "#FAF9FA",
...
export const darkColors = {
  ...baseColors,
  ...additionalColors,
  secondary: "#f7d757", // "#A881FC",
  secondary80: "#f7d75780", // "#A881FC80",
  background: "#111729", // "#08060B",
